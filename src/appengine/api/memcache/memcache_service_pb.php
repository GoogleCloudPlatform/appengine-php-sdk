...
//   }
// }
namespace google\appengine\api\memcache\MemcacheServiceError {
  class ErrorCode {
    const OK = 0;
...
namespace google\appengine\api\memcache {
  class MemcacheServiceError extends \google\appengine\runtime\proto\ProtocolMessage {
...
namespace google\appengine\api\memcache {
  class AppOverride extends \google\appengine\runtime\proto\ProtocolMessage {
...
namespace google\appengine\api\memcache {
  class MemcacheGetRequest extends \google\appengine\runtime\proto\ProtocolMessage {
    private $key = array();
    ...
    public function getOverride() {
      if (!isset($this->override)) {
        return new \google\appengine\api\memcache\AppOverride();
      }
      return $this->override;
    }
    public function mutableOverride() {
      if (!isset($this->override)) {
        $res = new \google\appengine\api\memcache\AppOverride();
        $this->override = $res;
        return $res;
      }
      return $this->override;
...
namespace google\appengine\api\memcache\MemcacheGetResponse {
  class Item extends \google\appengine\runtime\proto\ProtocolMessage {
...
namespace google\appengine\api\memcache {
  class MemcacheGetResponse extends \google\appengine\runtime\proto\ProtocolMessage {
    private $item = array();
    ...
    public function mutableItem($idx) {
      if (!isset($this->item[$idx])) {
        $val = new \google\appengine\api\memcache\MemcacheGetResponse\Item();
        $this->item[$idx] = $val;
        return $val;
      }
    ...
    public function getItem($idx) {
      ...
      return new \google\appengine\api\memcache\MemcacheGetResponse\Item();
    }
...
namespace google\appengine\api\memcache\MemcacheSetRequest {
  class SetPolicy {
    const SET = 1;
    const ADD = 2;
    const REPLACE = 3;
...
namespace google\appengine\api\memcache {
  class MemcacheSetRequest extends \google\appengine\runtime\proto\ProtocolMessage {
    private $item = array();
    public function getItemSize() {
      return sizeof($this->item);
    }
    ...
    public function mutableItem($idx) {
      if (!isset($this->item[$idx])) {
        $val = new \google\appengine\api\memcache\MemcacheSetRequest\Item();
        $this->item[$idx] = $val;
        return $val;
      }
      return $this->item[$idx];
    ...
    public function getItem($idx) {
      ...
      return new \google\appengine\api\memcache\MemcacheSetRequest\Item();
    }
    public function addItem() {
      $val = new \google\appengine\api\memcache\MemcacheSetRequest\Item();
      $this->item[] = $val;
...
namespace google\appengine\api\memcache\MemcacheSetResponse {
  class SetStatusCode {
    const STORED = 1;
    const NOT_STORED = 2;
    const ERROR = 3;
...
namespace google\appengine\api\memcache {
  class MemcacheSetResponse extends \google\appengine\runtime\proto\ProtocolMessage {
...
namespace google\appengine\api\memcache\MemcacheDeleteRequest {
  class Item extends \google\appengine\runtime\proto\ProtocolMessage {
    public function getKey() {
      if (!isset($this->key)) {
        return '';
...
namespace google\appengine\api\memcache {
  class MemcacheDeleteRequest extends \google\appengine\runtime\proto\ProtocolMessage {
    private $item = array();
    public function getItemSize() {
      return sizeof($this->item);
    }
    ...
    public function mutableItem($idx) {
      if (!isset($this->item[$idx])) {
        $val = new \google\appengine\api\memcache\MemcacheDeleteRequest\Item();
        $this->item[$idx] = $val;
        return $val;
      }
      return $this->item[$idx];
    ...
    public function getItem($idx) {
      ...
      return new \google\appengine\api\memcache\MemcacheDeleteRequest\Item();
    }
    public function addItem() {
      $val = new \google\appengine\api\memcache\MemcacheDeleteRequest\Item();
      $this->item[] = $val;
...
namespace google\appengine\api\memcache\MemcacheDeleteResponse {
...
namespace google\appengine\api\memcache {
  class MemcacheDeleteResponse extends \google\appengine\runtime\proto\ProtocolMessage {
...
namespace google\appengine\api\memcache\MemcacheIncrementRequest {
  class Direction {
    const INCREMENT = 1;
    const DECREMENT = 2;
  }
...
namespace google\appengine\api\memcache {
  class MemcacheIncrementRequest extends \google\appengine\runtime\proto\ProtocolMessage {
    public function getKey() {
      if (!isset($this->key)) {
        return '';
      }
...
namespace google\appengine\api\memcache\MemcacheIncrementResponse {
...
namespace google\appengine\api\memcache {
  class MemcacheIncrementResponse extends \google\appengine\runtime\proto\ProtocolMessage {
...
namespace google\appengine\api\memcache {
  class MemcacheBatchIncrementRequest extends \google\appengine\runtime\proto\ProtocolMessage {
    private $item = array();
    public function getNameSpace() {
      if (!isset($this->name_space)) {
        return '';
    ...
    public function mutableItem($idx) {
      if (!isset($this->item[$idx])) {
        $val = new \google\appengine\api\memcache\MemcacheIncrementRequest();
        $this->item[$idx] = $val;
        return $val;
      }
      return $this->item[$idx];
    ...
    public function getItem($idx) {
      ...
      return new \google\appengine\api\memcache\MemcacheIncrementRequest();
    }
    public function addItem() {
      $val = new \google\appengine\api\memcache\MemcacheIncrementRequest();
      $this->item[] = $val;
...
namespace google\appengine\api\memcache {
  class MemcacheBatchIncrementResponse extends \google\appengine\runtime\proto\ProtocolMessage {
    private $item = array();
    public function getItemSize() {
      return sizeof($this->item);
    }
    ...
    public function mutableItem($idx) {
      if (!isset($this->item[$idx])) {
        $val = new \google\appengine\api\memcache\MemcacheIncrementResponse();
        $this->item[$idx] = $val;
        return $val;
      }
      return $this->item[$idx];
    ...
    public function getItem($idx) {
      ...
      return new \google\appengine\api\memcache\MemcacheIncrementResponse();
    }
    public function addItem() {
      $val = new \google\appengine\api\memcache\MemcacheIncrementResponse();
      $this->item[] = $val;
...
namespace google\appengine\api\memcache {
  class MemcacheFlushRequest extends \google\appengine\runtime\proto\ProtocolMessage {
    public function getOverride() {
      if (!isset($this->override)) {
        return new \google\appengine\api\memcache\AppOverride();
      }
...
namespace google\appengine\api\memcache {
  class MemcacheFlushResponse extends \google\appengine\runtime\proto\ProtocolMessage {
    public function clear() {
    }
    public function byteSizePartial() {
      $res = 0;
...
namespace google\appengine\api\memcache {
  class MemcacheStatsRequest extends \google\appengine\runtime\proto\ProtocolMessage {
    public function getOverride() {
      if (!isset($this->override)) {
        return new \google\appengine\api\memcache\AppOverride();
      }
...
namespace google\appengine\api\memcache {
  class MergedNamespaceStats extends \google\appengine\runtime\proto\ProtocolMessage {
...
namespace google\appengine\api\memcache {
  class MemcacheStatsResponse extends \google\appengine\runtime\proto\ProtocolMessage {
    public function getStats() {
      if (!isset($this->stats)) {
        return new \google\appengine\api\memcache\MergedNamespaceStats();
      }
      return $this->stats;
    }
    public function mutableStats() {
      if (!isset($this->stats)) {
        $res = new \google\appengine\api\memcache\MergedNamespaceStats();
        $this->stats = $res;
        return $res;
      }
      return $this->stats;
...
namespace google\appengine\api\memcache {
  class MemcacheGrabTailRequest extends \google\appengine\runtime\proto\ProtocolMessage {
...
namespace google\appengine\api\memcache\MemcacheGrabTailResponse {
  class Item extends \google\appengine\runtime\proto\ProtocolMessage {
    public function getValue() {
      if (!isset($this->value)) {
        return '';
...
namespace google\appengine\api\memcache {
  class MemcacheGrabTailResponse extends \google\appengine\runtime\proto\ProtocolMessage {
    private $item = array();
    public function getItemSize() {
      return sizeof($this->item);
    }
    ...
    public function mutableItem($idx) {
      if (!isset($this->item[$idx])) {
        $val = new \google\appengine\api\memcache\MemcacheGrabTailResponse\Item();
        $this->item[$idx] = $val;
        return $val;
      }
      return $this->item[$idx];
    ...
    public function getItem($idx) {
      ...
      return new \google\appengine\api\memcache\MemcacheGrabTailResponse\Item();
    }
    public function addItem() {
      $val = new \google\appengine\api\memcache\MemcacheGrabTailResponse\Item();
      $this->item[] = $val;
